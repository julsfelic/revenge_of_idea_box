...
var Idea = (function () {
  function Idea(thumbsUpPath, thumbsDownPath) {
  ...
  _createClass(Idea, [{
    ...
    value: function postData(form) {
      ...
      $.post("/api/v1/ideas", form.data(), function (data) {
        var idea = _this.newIdea(data);
        $('.ideas').prepend(idea);
        form.clearFields();
      });
    }
    ...
    key: 'updateData',
    value: function updateData($quality) {
      $.ajax({
    ...
    value: function updateTitle($title) {
      var ideaId = $title.parent().data('id');
      $.ajax({
    ...
    value: function updateBody($body) {
      var ideaId = $body.parent().data('id');
      $.ajax({
    ...
    key: 'deleteData',
    value: function deleteData($idea) {
      $.ajax({
        dataType: 'json',
        method: 'DELETE',
...
var Form = require('./form.js.es6');
var form = new Form();

var thumbsUpPath = "/assets/thumbs_up-7a50c932fddf4369f0df9826ac4631b4868cc5b74576e39202e8548fb73ba171.png";
var thumbsDownPath = "/assets/thumbs_down-b67911f1632947dd1cd6b7305d60595962d645379fd130f4215a66420bfdae7e.png";

var Idea = require('./idea.js.es6');
var idea = new Idea(thumbsUpPath, thumbsDownPath);

var Quality = require('./quality.js.es6');
...
$(document).on('click', '.thumbs_down', function (e) {
  e.preventDefault();
  var $quality = $(this).prev().prev().prev();
...
function filterIdeas($ideas, term) {
  $ideas.each(function (index, idea) {
    var ideaText = $(idea).children('.idea-title, .idea-body');
    var ideaTitle = ideaText[0].innerText;
    var ideaBody = ideaText[1].innerText;
...
},{"./form.js.es6":2,"./idea.js.es6":3,"./quality.js.es6":4}],2:[function(require,module,exports){
class Form {
  data() {
    return {
      idea: {
...
var Quality = (function () {
  ...
  _createClass(Quality, null, [{
    key: 'qualities',
    value: function qualities() {
      return ['swill', 'plausible', 'genius'];
    }
  }, {
    key: 'increment',
    value: function increment($quality) {
      var index = this.qualities().indexOf($quality.html());
      $quality.html(this.qualities()[++index]);
    }
  }, {
    key: 'decrement',
    value: function decrement($quality) {
      var index = this.qualities().indexOf($quality.html());
      $quality.html(this.qualities()[--index]);
    }
  }]);
